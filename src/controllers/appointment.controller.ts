...
export const createAppointment = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const emailSubject = "Appointment Received - Pending Approval";
    const emailHtml = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px;">
        <h2 style="color: #2c3e50; text-align: center;">Appointment Request Received</h2>
        <p>Dear <strong>${name}</strong>,</p>
        <p>Thank you for choosing <strong>Theta Lounge</strong>. We have received your appointment request and it is currently waiting for admin approval.</p>
        ...
        <p>We will notify you via email as soon as your appointment is accepted. Please keep your Reservation ID for any future inquiries.</p>
